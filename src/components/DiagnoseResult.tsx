...
// This is the correct data structure for a diagnosis response from the API
type DiagnoseData = {
...
const DiagnoseResult: React.FC<DiagnoseResultProps> = ({ data, onTestImprovement }) => {
    // A robust check to ensure the necessary data is present before rendering
    if (!data || typeof data.criteria !== 'object') {
    ...
    const overallScoreNum = parseFloat(data.overall_score as string) || 0;
    ...
    return (
        <div className="p-6 border rounded-lg bg-gray-800 border-gray-700">
            ...
            <div className="mb-6 text-center bg-gray-900 p-4 rounded-lg">
                <p className="text-gray-400 text-sm font-semibold uppercase tracking-wider">Overall Score</p>
