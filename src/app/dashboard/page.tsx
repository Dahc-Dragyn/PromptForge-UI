...
// --- 1. IMPORT THE SAFARI-SAFE CLIPBOARD UTILITY ---
import { copyTextAsPromise } from '@/lib/clipboard';
...
// --- 2. CREATE THE HELPER FUNCTION FOR ASYNC TEXT ---
const fetchLatestPromptText = async (promptId: string): Promise<string> => {
  // This assumes your apiClient interceptor unwraps the .data property,
  // just like in SendToLlm.tsx
...
const DashboardContent = () => {
  ...
  const { activities, isLoading: activityLoading, isError: activityError } =
    useRecentActivity();
  ...
  // TEMPLATE HANDLERS (These are fine, no changes needed)
  ...
  // PROMPT HANDLERS (These are fine, no changes needed)
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-700/50">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          handleSendTemplateToLlm(template.content, 'Grok')
                        }
