...
import RatingModal from '@/components/RatingModal'; // <-- We will create this component next
...
const PromptVersionsPage = () => {
  ...
  // --- NEW: Handlers to open/close the rating modal ---
  const handleOpenRatingModal = (version: any) => {
              ...
              <div key={version.id || version.version} className="bg-gray-800 rounded-lg p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    {/* --- NEW: Test & Rate Button --- */}
                    <button 
                      onClick={() => handleOpenRatingModal(version)}
                      className="px-4 py-2 rounded-md text-sm font-semibold bg-yellow-500 hover:bg-yellow-600 text-black transition-colors"
                    >
                      Test & Rate
                    </button>
                    <button 
